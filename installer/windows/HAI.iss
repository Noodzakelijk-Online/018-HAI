...
Name: "{autoprograms}\HAI Local\Start governed cloud access"; Filename: "{sys}\WindowsPowerShell\v1.0\powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -File ""{app}\app\installer\windows\Start-HAI-Cloud.ps1"""; WorkingDir: "{app}\app"
Name: "{autoprograms}\HAI Local\Check local HAI connector"; Filename: "{sys}\WindowsPowerShell\v1.0\powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -File ""{app}\app\installer\windows\Test-HAI-LocalConnector.ps1"""; WorkingDir: "{app}\app"
