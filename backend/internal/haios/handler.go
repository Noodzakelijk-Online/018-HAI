...
func (h *Handler) Overview(c *gin.Context) {
	...
	c.JSON(http.StatusOK, HAIOSOverview{
		...
		Planes: []PlaneStatus{
			{Name: "Control", Status: "operational", Description: "Dashboard, automation registry, health, policy, and queues.", Links: []string{"/home", "/control-center"}},
			...
			{Name: "Reasoning", Status: "operational", Description: "Task classifier, criteria generator, context planner, model router, tool router, retry, and review.", Links: []string{"/task-blueprint", "/llm-policy"}},
			{Name: "Execution", Status: "guarded", Description: "Automation launch and controlled task run surfaces exist; autonomous execution remains approval-gated.", Links: []string{"/control-center", "/task-blueprint"}},
			...
			{Name: "Governance", Status: "guarded", Description: "Local-only source controls, paid budget policy, sensitive flags, approvals, and audit logs.", Links: []string{"/llm-policy", "/connected-sources", "/grounded-answers"}},
			{Name: "Observability", Status: "operational", Description: "Health summaries, sync logs, verification runs, routing logs, diagnostics, and review indicators.", Links: []string{"/control-center", "/connected-sources", "/grounded-answers"}},
		},
