...
var ossInsightCollectionDecisions = map[string]collectionDecision{
	...
	"RAG Frameworks":                       {CollectionReference, []string{"langchain", "llamaindex", "mem0", "letta", "langmem", "haystack"}, "HAI keeps one source-linked memory plane; framework patterns can inform a reviewed adapter but do not create a second memory authority."},
