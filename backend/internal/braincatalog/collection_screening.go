...
var ossInsightCollectionDecisions = map[string]collectionDecision{
	...
	"Data Integration":                     {CollectionRepresented, []string{"airbyte", "cloudquery"}, "HAI has a disabled local CloudQuery sync-summary reader only; CloudQuery credentials, configuration, raw source data, destinations, and execution remain external and require their own review."},
