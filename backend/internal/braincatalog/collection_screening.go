...
var ossInsightCollectionDecisions = map[string]collectionDecision{
	...
	"AI Evaluation & Testing":              {CollectionCandidate, []string{"promptfoo", "langfuse", "garak", "deepeval"}, "Evaluation tools are candidates for controlled regression and safety checks; test prompts and provider credentials remain sensitive."},
