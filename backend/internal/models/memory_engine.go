...
type AIConversationArchive struct {
	...
	OwnerIdentity    string     `gorm:"type:varchar(255);index;uniqueIndex:idx_ai_conversation_owner_identity" json:"ownerIdentity,omitempty"`
	Platform         string     `gorm:"type:varchar(50);index;uniqueIndex:idx_ai_conversation_owner_identity;not null" json:"platform"`
	ExternalID       string     `gorm:"type:varchar(255);index;uniqueIndex:idx_ai_conversation_owner_identity;not null" json:"externalId"`
