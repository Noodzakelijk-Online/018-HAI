...
// The project-instructions adapter is a deliberately narrow local reader for
// the two common agent-guidance files. Their contents remain untrusted source
// material: they can inform a reviewed plan, but never override HAI policy or
// grant a model, runtime, tool, filesystem, network, or approval capability.
