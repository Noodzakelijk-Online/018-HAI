...
| BH-7 | High (supply chain) | `frontend` deps | The original Angular 16 tree produced 91 audit records, including 4 critical and 59 high findings. | **Resolved for release-blocking severity** — migrated to Angular 22.1.1, ng-zorro 22.0.1, TypeScript 6.0.3, and the supported esbuild/Vite builder; 379 tests and the production build pass; audit is 0 high/critical and the CI high/critical gate is blocking. Three moderate Angular CLI-only records have a documented scope and 2026-09-09 review deadline. |
