...
| TD-6 | High | The backend dependency scan is clean and blocking, but the frontend audit remains advisory. Angular 16 currently reports 12 high and 1 moderate production dependency findings. | Migrate the Angular/CDK/ng-zorro family to a supported compatible release, retain the functional test contracts, clear or time-bound every accepted finding, then make the frontend audit blocking. |
